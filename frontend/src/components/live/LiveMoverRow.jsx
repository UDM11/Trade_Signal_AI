...
export default function LiveMoverRow({ stock, isGainer, rank, maxPct, mode, onClick }) {
    ...
    return (
        <button
            ...
            className={`group w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 text-left hover:-translate-y-[1px] ${flashClass}`}
            style={{ 
